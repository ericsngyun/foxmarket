...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="h-80 hidden md:block overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        <Image
          height={400}
          width={400}
          src="/checkout-thank-you.gif"
          ...
          <div className="lg:col-start-2">
            ...
            <div className = 'mt-16 text-sm font-medium'>
              ...
              <div className = 'space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'>
                ...
                <div className = 'flex justify-between'>
                  <p>Transaction Fee</p>
                  <p className = 'text-gray-900'>{formatPrice(5.99)}</p>
                </div>

                <div className = 'flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900'>
                  <p className = 'text-base'>Total</p>
                  <p className = 'text-base'> {formatPrice(orderTotal + 5.99)}</p>
                </div>
              </div>
