...
var components_2 = require("@react-email/components");
    ...
    return (react_1.default.createElement(components_1.Html, null,
        ...
        react_1.default.createElement(components_1.Body, { style: main },
            react_1.default.createElement(components_1.Container, { style: container },
                react_1.default.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/hippo-newsletter-sign-up.png"), width: "150", height: "150", alt: "FoxMarket", style: logo }),
                ...
                react_1.default.createElement(components_1.Text, { style: paragraph },
                    "Welcome to FoxMarket, the marketplace for high quality digital goods. Use the button below to ",
                    actionLabel,
                    "."),
...
var PrimaryActionEmailHtml = function (props) {
    return (0, components_2.render)(react_1.default.createElement(exports.EmailTemplate, __assign({}, props)), { pretty: true });
};
